...
/**
 * Manages a collection of buttons, their positions, and their associated prototype keys.
...
public class ButtonManager {
     ...
     * @return The prototype key, or null if the button is not managed by this manager
     */
    ...
    /**
     * Notifies the state change listener that a significant state change has occurred.
     *
